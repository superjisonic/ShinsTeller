                        ...
                        <div class="product_d_tab fix"> 
                            ...
                            <div class="tab-content simple_p_content">
                                <div class="tab-pane fade show active" id="p_d_tab1" role="tabpanel" >
                                    <div class="modal_tab_img simple_tab">
                                        <a href="#"><img src="/resources/assets/img/product/product18.jpg" alt=""></a>
                                        <div class="product_discount">
                                            <span>New</span>
                                        </div>
                                        <div class="view_img view_video">
                                            <a class="view_large_video" href="https://www.youtube.com/embed/DR2c266yWEA">View video <i class="fa fa-search-plus"></i></a>
                                        </div>    
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="p_d_tab3" role="tabpanel">
                                    <div class="modal_tab_img simple_tab">
                                        <a href="#"><img src="/resources/assets/img/product/product4.jpg" alt=""></a>
                                        <div class="product_discount">
                                            <span>New</span>
                                        </div>
                                        <div class="view_img view_video">
                            ...
                            <div class="product_d_tab_button simple_tab_button">    
                                <ul class="nav product_navactive" role="tablist">
                                    <li >
                                        <a class="nav-link active" data-toggle="tab" href="#p_d_tab1" role="tab" aria-controls="p_d_tab1" aria-selected="false"><img src="/resources/assets/img/cart/cart11.jpg" alt=""></a>
                                    </li>
                                    <li>
                                         <a class="nav-link" data-toggle="tab" href="#p_d_tab2" role="tab" aria-controls="p_d_tab2" aria-selected="false"><img src="/resources/assets/img/cart/cart8.jpg" alt=""></a>
                                    </li>
                                    <li>
                                       <a class="nav-link button_three" data-toggle="tab" href="#p_d_tab3" role="tab" aria-controls="p_d_tab3" aria-selected="false"><img src="/resources/assets/img/cart/cart2.jpg" alt=""></a>
                                    </li>
                                    <li>
                                       <a class="nav-link button_three" data-toggle="tab" href="#p_d_tab4" role="tab" aria-controls="p_d_tab4" aria-selected="false"><img src="/resources/assets/img/cart/cart4.jpg" alt=""></a>
                                    </li>
                                </ul>
                            </div>   
                        </div> 
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="product_d_right">
                            ...
                            <div class="product_reference">
                                <p>Reference: <span>demo_42</span></p>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="single_product categorie">
                                    <div class="product_thumb">
                                        <a href="single-product.html"><img src="/resources/assets/img/product/product11.jpg" alt=""></a>
                                        <div class="product_discount">
                                            <span>-10%</span>
                                        </div>
