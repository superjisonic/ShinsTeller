...
(function ($, videojs, undefined) {
  ...
  function registerVideoJsMarkersPlugin(options) {
    ...
    function registerMarkerTipHandler(markerDiv) {
    	//alert("registerMarkerTipHandler"+counta);
    	initializeMarkerTip();
    	  var marker = markersMap[$(markerDiv).data('marker-key')];
            ...
            markerTip.css({
              "left": getPosition(marker) + '%',
              "margin-left": -parseFloat(markerTip.width()) / 2 - 10 + 'px',
              "visibility": "visible"
            });
            
            markerTip.on("click",function(){
            	//alert(setting.markerTip.time(marker));
            	player.currentTime(setting.markerTip.time(marker));
            	$(".vjs-tip").removeClass("active");
    ...
    function initializeMarkerTip() {
      //alert("initializeMarkerTip" + counta);
    ...
    player.markers = {
      ...
      removeAll: function removeAll() {
        ...
        removeMarkers(indexArray);
        //videoWrapper.find('.vjs-progress-holder').remove(markerTip);
      },
